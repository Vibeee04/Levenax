...
def auth_users_markup(_, status: Union[bool, str] = None):
    buttons = [
        [
            InlineKeyboardButton(text=_["ST_B_18"], callback_data="AUTHANSWER"),
            InlineKeyboardButton(
        ...
        [
            InlineKeyboardButton(text=_["ST_B_3"], callback_data="AUTHLIST"),
        ],
        [
            InlineKeyboardButton(text=_["BACK_BUTTON"], callback_data="settingsback_helper"),
            InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")
...
def playmode_users_markup(
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text=_["ST_B_23"], callback_data="PLAYTYPEANSWER"),
            InlineKeyboardButton(
...
def cleanmode_settings_markup(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text=_["ST_B_24"], callback_data="CMANSWER"
            ),
            InlineKeyboardButton(
        ...
        [
            InlineKeyboardButton(
                text=_["ST_B_25"], callback_data="COMMANDANSWER"
            ),
            InlineKeyboardButton(
