...
from strings import helpers, get_command, get_string
...
async def helper_private(client: app, update: Union[types.Message, types.CallbackQuery]):
    ...
    if is_callback:
        ...
        await update.reply_photo(photo=START_IMG_URL, caption=_["help_1"].format(SUPPORT_GROUP), reply_markup=keyboard)
